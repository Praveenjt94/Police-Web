...
<head>
    ...
    <title>Police Web | Registration Page</title>
...
<div class="register-box">
    <div class="register-logo">
        <a href="assets/index.php"><b>Police</b>Web</a>
    </div>
    <div class="register-box-body">
        ...
        <form action="api/service.php" method="post">
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Date of birth dd/mm/yy" name="dob" required>
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Mobile phone" name="mobile_no" required>
